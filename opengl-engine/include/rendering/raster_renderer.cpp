...
class RasterRenderer : public Renderer {
	...
	unsigned int _vbo[3], _vao, _ebo[MAX_SCENE_OBJECTS], _fbo, _rbo;
...
public:
    RasterRenderer(Scene* scene) {
        ...
        /*_Vertices.push_back(glm::vec3(0, 1, 0));
        _Vertices.push_back(glm::vec3(1, 0, 0));
        _Vertices.push_back(glm::vec3(0, 0, 0));
        _Triangles.push_back({ 0, 1, 2 });*/
        Init();
	...
	void Init() override {
        ...
        glGenBuffers(3, _vbo);
        unsigned int vertex_vbo = _vbo[0], normal_vbo = _vbo[1], texc_vbo = _vbo[2];
